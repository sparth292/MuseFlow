            ...
            child: Column(
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    _buildCategoryCard(
                        context, 'Top Hits', Colors.cyan, Icons.trending_up),
                    _buildCategoryCard(context, 'New Releases', Colors.green,
                        Icons.new_releases),
                    _buildCategoryCard(
                        context, 'Pop Music', Colors.purple, Icons.music_note),
                    _buildCategoryCard(
                        context, 'Hip Hop', Colors.orange, Icons.album),
                  ],
                ),
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => MadeForYouScreen()),
                          );
                        },
                        child: Text(
                          'See All',
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      _buildPlaylistCard('Daily Mix 1',
                          'Gaming vibes for your focused sessions'),
